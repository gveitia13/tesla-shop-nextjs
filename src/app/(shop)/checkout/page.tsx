            ...
            <div className={'mt-5 mb-2 w-full'}>
              <div className={'mb-5'}>
                <small className={'text-xs'}>
                  Al hacer click en &#34;Colocar orden&#34;, aceptas nuestros <a href="#" className={'underline'}>términos
                  y condiciones</a> y <a className={'underline'} href="#"> política de privacidad.</a>
                </small>
              </div>
